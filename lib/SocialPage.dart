            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  ...
                  child: InkWell(                          onTap: () => _navigateToContactDetails(_contactsList[index]),
                    child: Text(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Email: ${contact['email']}', style: TextStyle(fontSize: 24.0)),
            Text('Phone: ${contact['phone']}', style: TextStyle(fontSize: 24.0)),
          ],
        ),
      ),
    );
